...
function AdminEditMembers({onClose, isOpen, members, memberRequests, editing, handleMemberStatus}) {
  return (
    <Modal onClose={onClose} isOpen={isOpen} isCentered scrollBehavior="inside" size="lg">
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <Divider mt={8} mb={4} />
          <GroupMemberList members={members}editing={editing} handleMemberStatus={handleMemberStatus} />
        </ModalBody>
        <ModalFooter>
