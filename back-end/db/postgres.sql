...
COPY group_members
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/group_members.csv' DELIMITER ',' CSV HEADER;
COPY group_requests
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/groups_request.csv' DELIMITER ',' CSV HEADER;
COPY friends
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/friends.csv' DELIMITER ',' CSV HEADER;
COPY messages
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/messages.csv' DELIMITER ',' CSV HEADER;
COPY posts
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/posts.csv' DELIMITER ',' CSV HEADER;
COPY post_photos
FROM '/Users/mattwaelder/hackreactor/blueocean/front-end/back-end/db/dummydata/post_photos.csv' DELIMITER ',' CSV HEADER;
COPY comments
